// backend/controllers/adminReport.controller.js
...
const getAdminReports = (req, res) => {
  try {
    ...
    const payload = {
      ...
      // 2. Task Completion Report (planned vs actual over time)
      taskCompletion: [
      ...
      // 6. Velocity (story points per sprint)
      velocity: [
    ...
    return res.status(500).json({ success: false, message: "Failed to load admin reports", error: err.message });
  }
};
