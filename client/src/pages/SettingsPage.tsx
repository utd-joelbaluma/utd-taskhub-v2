								...
								<div className="grid grid-cols-2 gap-4">
									<div>
										...
										<p className="text-[11px] text-muted mt-1.5">
											Max 6 characters. Used to generate
											ticket IDs.
										</p>
									</div>
									<div>
										...
										<p className="text-[11px] text-muted mt-1.5">
											Applied to new tickets with no
											priority set.
										</p>
									</div>
								</div>
							...
							<div className="space-y-6">
										...
										{[
											{
												...
												toggle: () =>
													setNotifAssigned((v) => !v),
											},
											{
												label: "I'm mentioned in a comment",
												icon: AtSign,
												checked: notifMentioned,
												toggle: () =>
													setNotifMentioned(
														(v) => !v,
													),
											},
											{
												...
												toggle: () =>
													setNotifStatusChange(
														(v) => !v,
													),
											},
											{
												label: "A new comment is posted",
												icon: MessageSquare,
											...
											{
												label: "A due date is approaching",
												icon: Clock,
												checked: notifDue,
												toggle: () =>
													setNotifDue((v) => !v),
								...
								<div className="grid grid-cols-2 gap-4">
									...
									<div>
										...
										<p className="text-[11px] text-muted mt-1.5">
											No push notifications during this
											window.
										</p>
									</div>
								</div>
